...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_gemv_q8(
    weight: *const i8,
    input: *const f32,
    scale: f32,
    n: usize,
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_gemv_q4(
    weight: *const u8,
    input: *const f32,
    scale: f32,
    n: usize,
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_gemv_q2(
    weight: *const u8,
    input: *const f32,
    scale: f32,
    n: usize,
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_gemv_q1(
    weight: *const u8,
    input: *const f32,
    scale: f32,
    n: usize,
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_gemm_q8(
    weight: *const i8,
    input: *const f32,
    output: *mut f32,
    scales: *const f32,
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_gemm_q4(
    weight: *const u8,
    input: *const f32,
    output: *mut f32,
    scales: *const f32,
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_kquant_matmul(
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_iq_matmul(
    weight_blocks: *const u8,
    input: *const f32,
    output: *mut f32,
    block_bytes: usize,
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_awq_matmul(
    weight: *const u32,
    zeros: *const u32,
    scales: *const f32,
    input: *const f32,
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_gptq_matmul(
    weight: *const u32,
    g_idx: *const i32,
    scales: *const f32,
    zeros: *const u32,
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_squeeze_matmul(
    weight_blocks: *const u8,
    input: *const f32,
    output: *mut f32,
    m: usize,
