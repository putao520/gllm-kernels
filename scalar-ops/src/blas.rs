...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_vec_add(a: *const f32, b: *const f32, out: *mut f32, n: usize) {
    for i in 0..n {
        unsafe {
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_vec_mul(a: *const f32, b: *const f32, out: *mut f32, n: usize) {
    for i in 0..n {
        unsafe {
            *out.add(i) = *a.add(i) * *b.add(i);
        }
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_exp(x: *const f32, out: *mut f32, n: usize) {
    for i in 0..n {
        unsafe {
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_softmax(x: *const f32, out: *mut f32, n: usize) {
    if n == 0 {
        return;
    }
    unsafe {
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_gemm(
    a: *const f32,
    b: *const f32,
    c: *mut f32,
    m: usize,
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_gemm_bias(
    a: *const f32,
    b: *const f32,
    bias: *const f32,
    c: *mut f32,
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_transpose_2d(
    input: *const f32,
    out: *mut f32,
    rows: usize,
    cols: usize,
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_reshape(input: *const f32, out: *mut f32, n: usize) {
    unsafe {
        for i in 0..n {
...
#[no_mangle]
#[inline(never)]
pub unsafe extern "C" fn scalar_quant_gemm(
    a: *const f32,
    b_quant: *const f32,
    b_scale: *const f32,
    c: *mut f32,
