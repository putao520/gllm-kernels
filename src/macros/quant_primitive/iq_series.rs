...
macro_rules! quant_primitive_iq {
    ...
    // IQ4_NL: 4-bit non-linear codebook lookup (BlockIQ4NL: d + qs[128], 256 elements)
    ...
    (neon, iq4_nl, dot, $block_ptr:expr, $other_ptr:expr) => {
        unsafe {
            #[cfg(target_arch = "aarch64")]
            {
                ...
                // IQ4_NL block_size=256, qs has 128 bytes → 8 chunks of 16 bytes (32 values each)
                for i in 0..8usize {
                    ...
                    let base = other.add(i * 32);
                    acc = $crate::simd_primitive!(neon, f32, fma, $crate::simd_primitive!(neon, f32, mul, vd, f0), $crate::simd_primitive!(neon, f32, load, base), acc);
                    acc = $crate::simd_primitive!(neon, f32, fma, $crate::simd_primitive!(neon, f32, mul, vd, f1), $crate::simd_primitive!(neon, f32, load, base.add(4)), acc);
                    acc = $crate::simd_primitive!(neon, f32, fma, $crate::simd_primitive!(neon, f32, mul, vd, f2), $crate::simd_primitive!(neon, f32, load, base.add(8)), acc);
                    acc = $crate::simd_primitive!(neon, f32, fma, $crate::simd_primitive!(neon, f32, mul, vd, f3), $crate::simd_primitive!(neon, f32, load, base.add(12)), acc);
                    ...
                    acc = $crate::simd_primitive!(neon, f32, fma, $crate::simd_primitive!(neon, f32, mul, vd, f4), $crate::simd_primitive!(neon, f32, load, base.add(16)), acc);
                    acc = $crate::simd_primitive!(neon, f32, fma, $crate::simd_primitive!(neon, f32, mul, vd, f5), $crate::simd_primitive!(neon, f32, load, base.add(20)), acc);
                    acc = $crate::simd_primitive!(neon, f32, fma, $crate::simd_primitive!(neon, f32, mul, vd, f6), $crate::simd_primitive!(neon, f32, load, base.add(24)), acc);
                    acc = $crate::simd_primitive!(neon, f32, fma, $crate::simd_primitive!(neon, f32, mul, vd, f7), $crate::simd_primitive!(neon, f32, load, base.add(28)), acc);
                }
    ...
    (avx2, iq4_nl, decode, $block_ptr:expr, $out_ptr:expr) => {
        unsafe {
            #[cfg(target_arch = "x86_64")]
            {
                ...
                // IQ4_NL block_size=256: 128 bytes of qs → 256 values
                // Process 8 chunks of 16 bytes each
                for i in 0..8 {
    ...
    (avx512, iq4_nl, decode, $block_ptr:expr, $out_ptr:expr) => {
        unsafe {
            #[cfg(target_arch = "x86_64")]
            {
                ...
                // IQ4_NL block_size=256, qs has 128 bytes → 256 4-bit values
        ...
        unsafe {
            #[cfg(target_arch = "aarch64")]
            {
                ...
                for i in 0..8usize {
                    ...
                    let base = out_ptr.add(i * 32);
                    $crate::simd_primitive!(neon, f32, store, base, $crate::simd_primitive!(neon, f32, mul, vd, f0));
                    $crate::simd_primitive!(neon, f32, store, base.add(4), $crate::simd_primitive!(neon, f32, mul, vd, f1));
                    $crate::simd_primitive!(neon, f32, store, base.add(8), $crate::simd_primitive!(neon, f32, mul, vd, f2));
                    $crate::simd_primitive!(neon, f32, store, base.add(12), $crate::simd_primitive!(neon, f32, mul, vd, f3));
                    ...
                    $crate::simd_primitive!(neon, f32, store, base.add(16), $crate::simd_primitive!(neon, f32, mul, vd, f4));
                    $crate::simd_primitive!(neon, f32, store, base.add(20), $crate::simd_primitive!(neon, f32, mul, vd, f5));
                    $crate::simd_primitive!(neon, f32, store, base.add(24), $crate::simd_primitive!(neon, f32, mul, vd, f6));
                    $crate::simd_primitive!(neon, f32, store, base.add(28), $crate::simd_primitive!(neon, f32, mul, vd, f7));
                }
            }
        }
    };
