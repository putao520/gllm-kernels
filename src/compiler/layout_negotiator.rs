...
mod tests {
    ...
    fn test_is_qkv_op_three_sibling_gemms() {
        ...
        graph.add_op(OpKind::Gemm { m: SymDim::Concrete(1), n: 512, k: 512, dtype: DType::F32, trans_b: false }, vec![input, wq], vec![oq], "q_proj");
        graph.add_op(OpKind::Gemm { m: SymDim::Concrete(1), n: 512, k: 512, dtype: DType::F32, trans_b: false }, vec![input, wk], vec![ok_], "k_proj");
        let v_op = graph.add_op(OpKind::Gemm { m: SymDim::Concrete(1), n: 512, k: 512, dtype: DType::F32, trans_b: false }, vec![input, wv], vec![ov], "v_proj");
    ...
    fn test_is_qkv_op_single_gemm_returns_false() {
        ...
        let op_id = graph.add_op(
            OpKind::Gemm { m: SymDim::Concrete(1), n: 128, k: 64, dtype: DType::F32, trans_b: false },
            vec![input, weight],
            vec![output],
            "single_gemm",
        );
    ...
    fn test_is_qkv_op_two_sibling_gemms_returns_false() {
        ...
        graph.add_op(OpKind::Gemm { m: SymDim::Concrete(1), n: 256, k: 256, dtype: DType::F32, trans_b: false }, vec![input, w1], vec![o1], "proj1");
        let op2 = graph.add_op(OpKind::Gemm { m: SymDim::Concrete(1), n: 256, k: 256, dtype: DType::F32, trans_b: false }, vec![input, w2], vec![o2], "proj2");
    ...
    fn test_model_aware_gemmbias_qkv_gets_headsplit() {
        ...
        graph.add_op(OpKind::GemmBias { m: SymDim::Concrete(1), n: 512, k: 512, dtype: DType::F32, trans_b: false }, vec![input, w1, b1], vec![o1], "q_proj");
        graph.add_op(OpKind::GemmBias { m: SymDim::Concrete(1), n: 512, k: 512, dtype: DType::F32, trans_b: false }, vec![input, w2, b2], vec![o2], "k_proj");
        let v_op = graph.add_op(OpKind::GemmBias { m: SymDim::Concrete(1), n: 512, k: 512, dtype: DType::F32, trans_b: false }, vec![input, w3, b3], vec![o3], "v_proj");
    ...
    fn test_model_aware_gemm_qkv_head_dim_extraction() {
        ...
        let q_op = graph.add_op(OpKind::Gemm { m: SymDim::Concrete(1), n: 640, k: 512, dtype: DType::F32, trans_b: false }, vec![input, w1], vec![o1], "q_proj");
        graph.add_op(OpKind::Gemm { m: SymDim::Concrete(1), n: 640, k: 512, dtype: DType::F32, trans_b: false }, vec![input, w2], vec![o2], "k_proj");
        graph.add_op(OpKind::Gemm { m: SymDim::Concrete(1), n: 640, k: 512, dtype: DType::F32, trans_b: false }, vec![input, w3], vec![o3], "v_proj");
    ...
    fn test_is_qkv_op_first_sibling_detected() {
        ...
        let q_op = graph.add_op(OpKind::Gemm { m: SymDim::Concrete(1), n: 256, k: 256, dtype: DType::F32, trans_b: false }, vec![input, w1], vec![o1], "q_proj");
        graph.add_op(OpKind::Gemm { m: SymDim::Concrete(1), n: 256, k: 256, dtype: DType::F32, trans_b: false }, vec![input, w2], vec![o2], "k_proj");
        graph.add_op(OpKind::Gemm { m: SymDim::Concrete(1), n: 256, k: 256, dtype: DType::F32, trans_b: false }, vec![input, w3], vec![o3], "v_proj");
    ...
    fn test_model_aware_gemm_qkv_without_mha_fallback_head_dim() {
        ...
        let q_op = graph.add_op(OpKind::Gemm { m: SymDim::Concrete(1), n: 512, k: 256, dtype: DType::F32, trans_b: false }, vec![input, w1], vec![o1], "q_proj");
        graph.add_op(OpKind::Gemm { m: SymDim::Concrete(1), n: 512, k: 256, dtype: DType::F32, trans_b: false }, vec![input, w2], vec![o2], "k_proj");
        graph.add_op(OpKind::Gemm { m: SymDim::Concrete(1), n: 512, k: 256, dtype: DType::F32, trans_b: false }, vec![input, w3], vec![o3], "v_proj");
