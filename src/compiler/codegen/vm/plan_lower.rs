...
use super::vm_state::{AbiPtrs, EmitState, HeteroPhase};
use super::x86_lower::X86Lower;

use crate::compiler::buffer_alloc::{BufferAllocation, TensorPtrSource, ALLOC_SEQ_CAP};
use crate::compiler::codegen::{
    CodegenOutput, DwcScratchRequirement, PleScratchRequirement, RopeCacheRequirement,
};
use crate::compiler::fusion::{FusionMode, FusionPlan, HeteroLayerType};
use crate::compiler::graph::{CompilerGraph, LayerCondition, SymDim, TensorId};
use crate::compiler::pain_point::{ExecPattern, OpBottleneckMap, ParallelismDesc};
...
include!("plan_lower/lower_op.inc.rs");
