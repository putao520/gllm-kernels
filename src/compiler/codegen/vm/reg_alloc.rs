...
impl<'a> RegAllocator<'a> {
    ...
    pub fn referenced_vregs(instr: &VmInstr) -> Vec<VRegId> {
        match instr {
            ...
            VmInstr::Comment(_) | VmInstr::ActivationSwap { .. } | VmInstr::PageTableAddr { .. } | VmInstr::PageTableKVWrite { .. } | VmInstr::PageTableKVWriteQuant { .. } | VmInstr::KiviQuantChannel { .. } | VmInstr::KiviQuantToken { .. } | VmInstr::KiviDequantLoad { .. } => vec![],
