...
impl VmProgram {
    ...
    fn remap_vreg_with_map(
        ...
        match instr {
            ...
            VmInstr::GatherLoad { dst, base, indices, stride, width } => VmInstr::GatherLoad { dst: r(dst, map, next_vreg), base: r(base, map, next_vreg), indices: r(indices, map, next_vreg), stride, width },
            VmInstr::ScatterStore { base, indices, src, stride, width } => VmInstr::ScatterStore { base: r(base, map, next_vreg), indices: r(indices, map, next_vreg), src: r(src, map, next_vreg), stride, width },
            ...
            VmInstr::MemCopy { dst, src, bytes } => VmInstr::MemCopy { dst: r(dst, map, next_vreg), src: r(src, map, next_vreg), bytes },
    ...
    fn remap_vreg_instr(instr: VmInstr, offset: u32) -> VmInstr {
        ...
        match instr {
            ...
            VmInstr::GatherLoad { dst, base, indices, stride, width } => VmInstr::GatherLoad { dst: r(dst), base: r(base), indices: r(indices), stride, width },
            VmInstr::ScatterStore { base, indices, src, stride, width } => VmInstr::ScatterStore { base: r(base), indices: r(indices), src: r(src), stride, width },
            ...
            VmInstr::MemCopy { dst, src, bytes } => VmInstr::MemCopy { dst: r(dst), src: r(src), bytes },
