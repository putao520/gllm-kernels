...
pub(crate) fn emit_elementwise_kernel_ptx(
    out: &mut String,
    kernel_name: &str,
    body: &[TraceOp],
) {
...
pub(crate) fn emit_binary_elementwise_kernel_ptx(
    out: &mut String,
    kernel_name: &str,
    body: &[TraceOp],
) {
...
pub(crate) fn emit_normlike_kernel_ptx(
    out: &mut String,
    kernel_name: &str,
    reduce: &[TraceOp],
    finalize: &[TraceOp],
...
pub(crate) fn emit_softmax_kernel_ptx(out: &mut String, kernel_name: &str) {
    let block_size: u32 = 256;
    writeln!(out, ".visible .entry {kernel_name}(").unwrap();
    writeln!(out, "    .param .u64 param_input,").unwrap();
    writeln!(out, "    .param .u64 param_output,").unwrap();
...
pub(crate) fn emit_meanpool_kernel_ptx(
    out: &mut String,
    kernel_name: &str,
    seq_len: usize,
    hidden: usize,
...
pub(crate) fn emit_dequantize_kernel_ptx(
    out: &mut String,
    kernel_name: &str,
    num_elements: usize,
    block_size: usize,
